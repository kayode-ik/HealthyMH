...
<!-- Mirrored from preview.colorlib.com/theme/counselor/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2021 08:06:36 GMT -->
...
<body>
  ...
  <section class="hero-wrap hero-wrap-2" id="contact_header" style="    margin-top: 64px;
  margin-bottom: -9px;
">
            ...
            <div class="row mb-5">
              <div class="col-md-4">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Address:</span> 198 West 21th Street, Suite 721 New York NY 10016</p><br>
                    <!-- <h5>Visit my office to set up a free 1 hour meeting to get to know me and my techniques in detail so you can decide if you want to continue working with me.</h5> -->
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Phone:</span> <a href="tel://1234567920">555 67 78 564</a></p>
                    <br><br>
                    <!-- <h5>Call my office to set up a free 1 hour meeting to get to know me and my techniques in detail so you can decide if you want to continue working with me.</h5> -->
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Email:</span> <a>hello@thehealthymarriage.com</a></p>
                      <br>
                    <!-- <h5>Email my office to set up a free 1 hour meeting to get to know me and my techniques in detail so you can decide if you want to continue working with me.</h5> -->
                  </div>
                </div>
              </div>
            </div>
...
<!-- Mirrored from preview.colorlib.com/theme/counselor/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2021 08:06:36 GMT -->
